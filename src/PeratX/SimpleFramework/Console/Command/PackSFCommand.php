...
class PackSFCommand implements Command{
	...
	public function execute(string $command, array $args) : bool{
		...
		$phar->setStub('<?php define("PeratX\SimpleFramework\\\\PATH", "phar://". __FILE__ ."/"); require_once("phar://". __FILE__ ."/src/PeratX/SimpleFramework/SimpleFramework.php");  __HALT_COMPILER();');
		$phar->setSignatureAlgorithm(\Phar::SHA1);
		$phar->startBuffering();

		$filePath = substr(\PeratX\SimpleFramework\PATH, 0, 7) === "phar://" ? \PeratX\SimpleFramework\PATH : realpath(\PeratX\SimpleFramework\PATH) . "/";
